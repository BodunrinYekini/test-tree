...
PRODUCT_COPY_FILES += \
    $(call find-copy-subdir-files,*,$(LOCAL_PATH)/modules/vendor/etc/permissions/,$(TARGET_COPY_OUT_VENDOR)/etc/permissions) \
     ...
     $(call find-copy-subdir-files,*,$(LOCAL_PATH)/modules/vendor/lib/*.so,$(TARGET_COPY_OUT_VENDOR)/lib) \
     $(call find-copy-subdir-files,*,$(LOCAL_PATH)/modules/vendor/lib64/*.so,$(TARGET_COPY_OUT_VENDOR)/lib64)

VENDOR_DLKM_MODULES_PATH = $(DEVICE_PATH)/modules/vendor_dlkm/lib/modules
PRODUCT_COPY_FILES += \
    $(call find-copy-subdir-files,*,$(VENDOR_DLKM_MODULES_PATH)/,$(TARGET_COPY_OUT_VENDOR_DLKM)/lib/modules)
